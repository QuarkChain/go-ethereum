...
If using tendermint as consensus, since tendermint consensus requires using p2p protocol to 
reach consensus among nodes, it uses 33333 as default port and can be specified by `--validator.port`. 
Tendermint node key can also be specified by `--validator.nodekey`.
