...
// ExternalCallREsult returns the externalCallResult for the given transaction hash
func (ec *Client) ExternalCallResult(ctx context.Context, txHash common.Hash) (*ExternalCallResult, error) {
	var r *ExternalCallResult
